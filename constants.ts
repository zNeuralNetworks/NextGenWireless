// ROI Calculator Constants (Illustrative only)
export const ROI_CONSTANTS = {
  // Hardware & Infra
  CONTROLLER_UNIT_COST: 18000, 
  CONTROLLER_ANNUAL_SUPPORT: 3000,
  APS_PER_CONTROLLER_PAIR: 100,
  
  // Subscriptions (Annual/AP) - Generic Market Averages
  SUB_LEGACY: 150, 
  SUB_CLOUD: 180,
  SUB_DISTRIBUTED: 180, 
  ...
  // Operational Costs
  HOURLY_RATE: 115,
  STAGING_COST_LEGACY: 2500, // Per site (bench, shipping, labor)
  STAGING_COST_DISTRIBUTED: 500, // Per site (drop ship)
  
  // Operational Efficiency
  TICKET_HOURS_LEGACY: 4.5, // Multi-tier escalation
  TICKET_HOURS_DISTRIBUTED: 1.2, // Root cause identified
};
...
export const NAV_ITEMS = [
  ...
  { id: 'grid', label: 'Comparison' },
  { id: 'paradox', label: 'The Paradox' },
  { id: 'behaviors', label: 'Behaviors' },
  { id: 'ztp', label: 'Deployment' },
  { id: 'roi', label: 'Value & ROI' },
  { id: 'failure', label: 'Resilience' },
...
// ──────────────────────────────────────────────────────────────────────────
// Architecture Scenario Engine Constants
// ──────────────────────────────────────────────────────────────────────────
...
export interface Scenario {
  ...
  icon: 'building' | 'map-pin' | 'activity' | 'layers' | 'arrow-up';
  initialConfig: {
    sandboxAPs: number;
